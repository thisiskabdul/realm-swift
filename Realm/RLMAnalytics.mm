...
static NSDictionary *RLMConfigurationMetrics(RLMRealmConfiguration *configuration) {
    ...
    return @{
        ...
        // Client Reset
        @"Client_Reset_Recover_Or_Discard": resetMode == RLMClientResetModeRecoverOrDiscardUnsyncedChanges ? @1 : @0,
        @"Client_Reset_Recover": resetMode == RLMClientResetModeRecoverUnsyncedChanges ? @1 : @0,
        @"Client_Reset_Discard": resetMode == RLMClientResetModeDiscardUnsyncedChanges ? @1 : @0,
        @"Client_Reset_Manual": resetMode == RLMClientResetModeManual ? @1 : @0,
